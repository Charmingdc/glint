...
export function Hero() {
 return (
  <main className='flex flex-1 flex-col items-center justify-center px-8 py-24 text-center'>
   ...
   >
    Generate unqiue, deterministic avatars from any seed.
   </motion.p>
   ...
   >
    ...
    <a
     href='/playground'
     className='inline-flex w-full items-center justify-center gap-2 rounded-3xl  border border-white/10 bg-card px-5 py-3.5 text-sm font-medium text-foreground/70 transition-colors hover:text-foreground hover:border-white/20 sm:w-auto'
    >
     <HugeiconsIcon
      icon={PlayCircleIcon}
      size={16}
