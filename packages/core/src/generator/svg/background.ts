...
export const generateBg = ({
 ...
 const rects = `
    <rect width="100%" height="100%" rx="${radius}" ry="${radius}" fill="url(#${gradient1Id})" />
    <rect width="100%" height="100%" rx="${radius}" ry="${radius}" fill="url(#${gradient2Id})" />
    <rect width="100%" height="100%" rx="${radius}" ry="${radius}" fill="url(#${gradient3Id})" />
  `.trim();
